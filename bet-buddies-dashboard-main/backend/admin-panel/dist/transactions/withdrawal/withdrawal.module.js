...
const transactions_1 = require("../../model/transactionsSchema/transactions");
let AddCurrencyTokenModule = class AddCurrencyTokenModule {
};
AddCurrencyTokenModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'Withdrawal', schema: transactions_1.TransactionsSchema }], 'bet-buddies')],
        controllers: [],
        providers: []
    })
